...
player_scores = [0, 0]
current_player = 0
waiting_for_space = False  # Flag to wait for a space bar press
waiting_for_enter = True  # Flag to wait for an Enter key press
...
while True:
    ...
    if hand:
        ...
        if lmlist:
            ...
            if fingerup == [0, 1, 0, 0, 0] and waiting_for_space:
                ...
                waiting_for_space = False
            #elif fingerup == [0, 0, 0, 0, 0] and waiting_for_enter:
    ...
    if waiting_for_space:
        ...
        cv2.putText(img, "Press 'Enter' to Swap Players", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    ...
    if key == ord('q'):
        ...
        waiting_for_enter = True  # Wait for the next Enter key press
        current_player = 1 - current_player  # Toggle player
        waiting_for_enter = False
